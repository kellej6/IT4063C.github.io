...
```
    ...
    File ~/.pyenv/versions/3.10.4/envs/it4063c/lib/python3.10/site-packages/IPython/core/formatters.py:973, in MimeBundleFormatter.__call__(self, obj, include, exclude)
    ...
    File ~/.pyenv/versions/3.10.4/envs/it4063c/lib/python3.10/site-packages/altair/vegalite/v4/api.py:1679, in TopLevelMixin._repr_mimebundle_(self, include, exclude)
       1677     return {}
       1678 else:
    -> 1679     return renderers.get()(dct)


    File ~/.pyenv/versions/3.10.4/envs/it4063c/lib/python3.10/site-packages/altair/vegalite/v4/display.py:65, in svg_renderer(spec, **metadata)
    ...
    File ~/.pyenv/versions/3.10.4/envs/it4063c/lib/python3.10/site-packages/altair/utils/mimebundle.py:60, in spec_to_mimebundle(spec, format, mode, vega_version, vegaembed_version, vegalite_version, **kwargs)
    ...
    File ~/.pyenv/versions/3.10.4/envs/it4063c/lib/python3.10/site-packages/altair_saver/_core.py:255, in render(chart, fmts, mode, embed_options, method, **kwargs)
    ...
    File ~/.pyenv/versions/3.10.4/envs/it4063c/lib/python3.10/site-packages/altair_saver/_core.py:69, in _select_saver(method, mode, fmt, fp)
