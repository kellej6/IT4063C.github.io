...
### TL;DR;
- git and an account on [GitHub.com](github.com)
- [Visual Studio Code](https://code.visualstudio.com/download)
  - Not Visual Studio
- [Azure Data Studio](https://docs.microsoft.com/en-us/sql/azure-data-studio/download-azure-data-studio?view=sql-server-ver16#download-azure-data-studio)
- Docker 
