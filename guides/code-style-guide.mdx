...
**Make sure** to check it out before starting on your assignments, and make sure you follow the code style guidelines presented here.
:::

## What is this code style guide about?

Generally, programmers, data analysts, and professionals agree that there are some ways of writing code that are more understandable and _readable_ than others.
